...
$enquetes = $conexao->query("
    ...
    FROM enquetes
    INNER JOIN opcoes ON opcoes.enquete_id = enquetes.id
    LEFT JOIN votos ON votos.opcao_id = opcoes.id
...
<section>
    ...
    ?>
            ...
            <div class="enquete-card">
                ...
                <h2><?= $resultado['enquete'] ?></h2>

                <div>

                <?php endif; ?>

                <p><?= $resultado['opcao'] ?>&nbsp;<strong><?= $resultado['total_votos'] ?> votos</strong></p>
